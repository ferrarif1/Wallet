...
const Privacy = () => (
  <div className={styles['p-privacy']}>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>The Information We Collect About You</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>How We Use Your Information</h2>
      We use your information, including personal information, for the following purposes:
    </section>

    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Provide our services</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Provide personalized services</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Improve and develop our services</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Offer promotions</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Other Uses</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>How We Share Your Information</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Our Use of Cookies and Other Tracking Mechanisms</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Cookies</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Disabling Cookies</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Third Party Analytics.</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Third-Party Links</h2>
      Our Site and Services may contain links to third-party websites. Any access to and use of such linked websites is not governed by this Policy, but instead is governed by the privacy policies of those third party websites. We are not responsible for the information practices of such third party websites.
    </section>

    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Personal Information</h2>
      ...
      You may request access, a copy, modification or deletion of personal information that you have submitted to us by contacting us at support@coinstart.io. We will use reasonable efforts to accommodate such requests to the extent required by law, provided that we may be required to retain personal information to comply with legal obligations, accounting requirements, or for other business purposes. We may request additional information to verify the identity of the requesting party before responding to a request. Please note that copies of information that you have updated, modified or deleted may remain viewable in cached and archived pages of the Site for a period of time.
      ...
      Our Site and Services are offered from the Taiwan. We store any information we collect in  Taiwan. If you access the Services or Site from outside the Taiwan, you agree to the transfer of your information to the Taiwan, which may have less protections for your personal information than your jurisdiction of residence.
    </section>

    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Children Under 13</h2>
    ...
    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Contact Us</h2>
      If you have questions about the privacy aspects of our Site or Services or would like to make a complaint, please contact us at support@coinstart.io
    </section>

    <section className={styles['p-privacy-section']}>
      <h2 className={styles['p-privacy-h2']}>Changes to this Policy</h2>
